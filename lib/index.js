...
const mcpCommand = require("./command-mcp");
...
// Re-export types from migrations module
/**
 * @typedef {import('./migrations').MigrationScriptArguments} MigrationScriptArguments
 * @typedef {import('./migrations').MigrationScriptCallback} MigrationScriptCallback
 * @typedef {import('./migrations').MigrationHelpers} MigrationHelpers
 * @typedef {import('./migrations').MigrationLifecycleFunctions} MigrationLifecycleFunctions
 * @typedef {import('./migrations').MigrateInstanceOptions} MigrateInstanceOptions
 */
